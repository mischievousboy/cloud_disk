...
macro(gen_server TARGET LOCALSRCDIR)

  aux_source_directory(${PROJECT_SOURCE_DIR} SRC_FILES)
  if (NOT "${LOCALSRCDIR}" STREQUAL "")
    string(REPLACE " " ";" SRCLIST ${LOCALSRCDIR})
    foreach (SRCDIR ${SRCLIST})
      aux_source_directory(${PROJECT_SOURCE_DIR}/${SRCDIR} SRC_FILES)
    endforeach (SRCDIR ${SRCLIST})
  endif ()
  ...
  target_link_libraries(${TARGET}_grpc_proto
          ${_REFLECTION}
          ${_GRPC_GRPCPP}
          ${_PROTOBUF_LIBPROTOBUF})

  add_executable(${TARGET} ${SRC_FILES})
  add_dependencies(${TARGET} ${TARGET}_grpc_proto ${LIBCOMMON})
...
macro(gen_client SERVER TARGET)
  ...
  add_executable(${TARGET} ${SRC_FILES})
  add_dependencies(${TARGET} ${SERVER}_grpc_proto)
  target_link_libraries(${TARGET}
          ${SERVER}_grpc_proto
          ${_REFLECTION}
          ${_GRPC_GRPCPP}
